...
### T022 — Playtest & équilibrage V1

- Premier équilibrage V1 après playtest statique des données de combat
- La courbe de mana du deck de départ est stabilisée : plus de Forest, moins de grosses cartes mortes en main de départ
- Les ennemis faibles restent en early-game : PV réduits, pas de Lightning Bolt, pas de Craw Wurm
- Les ennemis moyens marquent mieux le danger progressif : plus de terrains, menaces 4–5 mana, PV au-dessus des faibles
- Le boss garde le pic de risque : plus haut total de PV, plus de terrains, Air Elemental, Craw Wurm et plusieurs Lightning Bolt
- Les récompenses restent simples : elles servent à ajouter les grosses cartes et sorts puissants au fil de la run
- Pas encore de vrai playtest runtime Godot automatisé, ni d’ajustement fin par télémétrie
